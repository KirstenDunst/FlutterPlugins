 ...
 */
public class LimitingDirectionCsxPlugin implements FlutterPlugin, MethodCallHandler,SensorEventListener {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        mSensorManager = (SensorManager) applicationContext.getSystemService(SENSOR_SERVICE);
