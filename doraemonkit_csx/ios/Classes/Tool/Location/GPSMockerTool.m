...
#import "GPSMockerTool.h"
#import "NSObject+Doraemon.h"
#import "CLLocationManager+Doraemon.h"

@interface GPSMockerTool()<CLLocationManagerDelegate>
...
@implementation GPSMockerTool
+ (void)load {
    [[GPSMockerTool shareInstance] swizzleCLLocationMangagerDelegate];
}

+ (GPSMockerTool *)shareInstance{
    static dispatch_once_t once;
    static GPSMockerTool *instance;
    dispatch_once(&once, ^{
        instance = [[GPSMockerTool alloc] init];
    });
    return instance;
}
