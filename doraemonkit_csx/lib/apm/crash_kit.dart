...
class CrashLogManager {
  ...
  void addLog(int type, String msg) {
    if (ApmKitManager.instance.getKit(ApmKitName.kitCarsh) != null) {
      var log = CrashLogBean(type, msg);
      var kit = ApmKitManager.instance.getKit(ApmKitName.kitCarsh);
      kit!.save(log);
      if (listener != null) {
        listener?.call(log);
      }
  ...
  void addException(String exception) {
    addLog(CrashLogBean.typeError, exception);
  }
}
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    var kit = ApmKitManager.instance.getKit(
                      ApmKitName.kitCarsh,
                    );
                    kit?.removeAllItem();
                    setState(() {});
...
class _LogItemWidgetState extends State<LogItemWidget> {
  static const String keyShowLogExpandTips = 'key_show_log_expand_tips';
