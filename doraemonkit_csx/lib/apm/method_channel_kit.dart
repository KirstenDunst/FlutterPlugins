...
class MethodChannelKit extends ApmKit {
  ...
  @override
  String getIcon() {
    return 'assets/images/dk_method_channel.png';
  }
        ...
        Expanded(
          child: Container(
            ...
            child: ListView.builder(
              ...
              padding: EdgeInsets.only(left: 4, right: 4, bottom: 0, top: 0),
              reverse: true,
              shrinkWrap: true,
              ...
              child: RichText(
                ...
                text: TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text:
                          '  Cost:${widget.item.endTimestamp > 0 ? ('${widget.item.endTimestamp - widget.item.startTimestamp}ms') : '-'} ',
                      style: TextStyle(
                        fontSize: 9,
