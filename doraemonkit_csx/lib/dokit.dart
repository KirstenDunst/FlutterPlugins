...
const String dkPackageVersion = '0.8.0-nullsafety.0';
...
//         () async => <void>{
//           _ensureDoKitBinding(app ?? await appCreator!(),useInRelease: useInRelease),
//           _zone = Zone.current
//         },
...
//     ?..scheduleAttachRootWidget(binding.wrapWithDefaultView(wrapper))
//     ..scheduleWarmUpFrame();
//   addEntrance();
// }
