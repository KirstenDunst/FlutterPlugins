...
void main() {
  runApp(new MyApp());
  ImageCompressCsx.showNativeLog = true;
}
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> compress() async {
    ...
    final result =
        await ImageCompressCsx.compressWithList(data.buffer.asUint8List());
  ...
  Future<Uint8List> testCompressFile(File file) async {
    ...
    final result = await ImageCompressCsx.compressWithFile(
      file.absolute.path,
      minWidth: 2300,
      minHeight: 1500,
      quality: 94,
  ...
  Future<File> testCompressAndGetFile(File file, String targetPath) async {
    ...
    final result = await ImageCompressCsx.compressAndGetFile(
      file.absolute.path,
      targetPath,
      quality: 90,
      minWidth: 1024,
  ...
  Future testCompressAsset(String assetName) async {
    ...
    final list = await ImageCompressCsx.compressAssetImage(
      assetName,
      minHeight: 1920,
      minWidth: 1080,
      quality: 96,
  ...
  Future<Uint8List> testComporessList(Uint8List list) async {
    final result = await ImageCompressCsx.compressWithList(
      list,
      minHeight: 1080,
      minWidth: 1080,
      quality: 96,
  ...
  void _compressAssetAndAutoRotate() async {
    final result = await ImageCompressCsx.compressAssetImage(
